                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                                <label for="phnoe_no" class="col-md-4 col-form-label text-md-right">{{ __('Mobile Number') }}</label>

                                <div class="col-md-6">
                                    <input id="phnoe_no" type="tel" maxlength="11" class="form-control{{ $errors->has('phnoe_no') ? ' is-invalid' : '' }}"
                                           name="phnoe_no" value="{{ old('phnoe_no') }}" required autofocus>

                                    @if ($errors->has('phnoe_no'))
                                        <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('phnoe_no') }}</strong>
                                    </span>
                                    @endif
                                </div>
                            </div>
