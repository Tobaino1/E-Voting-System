        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}" style="color: blue">
                    ...
                    Action Democratic Party | E-Voting-System
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li class="nav-link">
         <a class="nav-link" href="{{ route('registerMember') }}" style="color: white">Register Member</a>
      </li> 

       <!-- <li class="nav-link">
         <a class="nav-link" href="{{ route('register') }}" style="color: white">View Registered Members</a>
      </li>  -->
                    </ul>
